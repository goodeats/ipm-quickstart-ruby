$(function() {
  ...
  function initTwilio(){
    ...
    $.getJSON('/token', {
      ...
      data.token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..QyI_4ervg80RjAF_OTWfX9w3etK8zsTiCO7R7uzYIpk';
    ...
    function sortChannelsByLastMessage(channels, sidebar, messageBoard){
      channels.sort(function(a, b){
        ...
        if (al > 0){
          ...
          console.log(':*(');
          channelA = a.messages[al-1].dateCreated;
        }
