$(function() {
  ...
  $.getJSON('/token', {
    ...
    data.token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..2jtX5xBs5nsKVLd91x2cq8RylAZNB2APcTHnopwoVo8';
  ...
  function setupChannel() {
    ...
    invite_button.on('click', function(e){
      ...
      generalChannel.invite('elmo').then(function() {
    ...
    //   generalChannel.leave('elmo').then(function() {
    //     console.log('Your friend has been leaved!');
    //   });
    // });
