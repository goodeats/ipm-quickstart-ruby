$(function() {
  ...
  function initTwilio(){
    ...
    $.getJSON('/token', {
      ...
      data.token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..ThXDDmE6Nm-U_wmcgaw7NsUOnNg7iVAm65pMUAU4Njg';
    ...
    function prepareNewChannelForm(){
    ...
    function findOrCreateChannel(uniqueName, friendlyName){
      ...
      promise.then(function(channel) {
        ...
        if (!myChannel) {
          ...
          print('Found "' + channel.friendlyName + '" channel');
